# Field 13 — PRC-1: Scientific and/or Technical (S/T) Merit

**Form section:** Component 1a → PRC-1 (10 pts) · **Cap:** 3,000 characters
**LOCAL CHAR COUNT:** 2541 (cap 3,000)
**Source:** `../proposal/PRC-1_st_merit.md` — R8 team/hardware amendment + 2026-07-13 benchmark; blank lines stripped per DIP rule.
...
- After paste, DIP's counter should read ~2541 (±2). If it reads noticeably higher, normalize smart chars (— – µ " ') to ASCII and re-paste.
