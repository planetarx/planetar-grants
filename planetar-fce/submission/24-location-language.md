# Location and Language of Work — what to enter

**DIP page:** Component 1a → Location and Language of Work
...
## Language of Work
Select: **English**.
- The contract work is performed in English. Do **not** select "English and French" — that's a *work-language capability* claim and overstating it can create problems at contract time.
- Separate from the **bilingual (EN/FR) UI** proposed in PRC-5/GBA+ — that's a product feature for CAF operators, not the language you perform the work in.

## Still ahead in the wizard (prep on request)
